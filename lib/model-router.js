...
// CAMERA_PRIMARY: gpt-5.5       — canonical model for ALL photo→JSON flows.
//                                 Upgraded 2026-05-26 from gpt-4o (per
//                                 founder ask: "use the best models, I
//                                 don't care"). GPT-5.5 ranks #4 of 63 on
//                                 Roboflow Vision Evals (76.12% overall)
//                                 and dominates JFB nutrition tasks now
//                                 that the Jan-AI 2025 GPT-4o baseline
//                                 (23.5% wMAPE) is superseded. Gemini 3.1
//                                 Pro tops the absolute multimodal
//                                 leaderboard (82.8 vs GPT-5.5 70.4) but
//                                 lives on the FALLBACK path in nutrition
//                                 `_multiShotVision` (Path B → callGeminiVision),
//                                 so failure modes are uncorrelated.
//                                 Used by nutrition `_multiShotVision`,
//                                 nutrition `scanNutritionLabel`, water
//                                 `/log/from-photo`. Single string here →
//                                 swap once when a new model wins.
//
...
const MODELS = {
  ...
  cameraPrimary:  'gpt-5.5',        // CANONICAL — every photo→JSON call uses this (was gpt-4o, upgraded 2026-05-26)
};
