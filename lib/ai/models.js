...
//
//   AI.STRUCTURED_HEAVY  Smartest non-reasoning model. Use for heavy
//                      structured-JSON outputs where reasoning-token
//                      bleed would truncate the visible response (e.g.
//                      multi-day plan generation, big card layouts).
//                      Default: OpenAI gpt-4.1 (~$2/$8 per 1M).
//
...
const AI = Object.freeze({
  ...
  STRUCTURED_HEAVY: _override('AI_STRUCTURED_HEAVY', 'gpt-4.1'),
